...
# ------------------ You shouldn't change above but you can ---------------
    ...
    for character in enemyteam:
        if not character.is_dead() and target == None:
                ...
                if character.in_range_of(target, gameMap):
                    ...
                    if character.casting is None:
                        ...
                        for abilityId, cooldown in character.abilities.items():
                            ...
                            if abilityId == 0:
                                if character.attributes.get_attribute("Stunned") < 0 or character.attributes.get_attribute("Silenced") < 0 or character.attributes.get_attribute("Rooted") < 0:
                                    if cooldown == 0:
                                        ...
                                        cast = True
                                        break
                            elif abilityId == 3 and (character.attributes.get_attribute("Health") <= 925):
                                if cooldown == 0:
                                    # If I can, then cast it
                                    ability = game_consts.abilitiesList[int(abilityId)]
                                    # Get ability
